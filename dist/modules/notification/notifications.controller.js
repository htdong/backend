...
var NotificationsController = {
    ...
    */
    ...
    module11: (req, res, notificationObject) => __awaiter(this, void 0, void 0, function* () {
        try {
            // helperService.log(notificationObject);
            let Notification = yield NotificationsController.getModel(req, res);
            let notification = new Notification(notificationObject);
            let notificationResult = yield notification.save();
    ...
    module12: (req, res) => __awaiter(this, void 0, void 0, function* () {
        try {
            if (!mongoose.Types.ObjectId.isValid(req.params._id)) {
                ...
                let Notification = yield NotificationsController.getModel(req, res);
                let notification = yield Notification.findById(req.params._id);
        ...
        try {
            ...
            if (!mongoose.Types.ObjectId.isValid(req.params._id)) {
                ...
                if (!notification) {
                    ...
                    let updatedClient = yield notification.save();
                    if (updatedClient) {
                        const result = {
                            data: updatedClient,
                        };
        ...
        try {
            if (!mongoose.Types.ObjectId.isValid(req.params._id)) {
                ...
                if (!notification) {
                    ...
                    let removedNotification = yield notification.remove();
    ...
    */
    module1x: (req, res) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let notifications = yield Notification.paginate(query, options);
            const result = {
